...
enum parameters {ELEMENT_LENGTH,THAO,KAPPA,LAMBDA,VELOCITY,PSI,ALPHA,DELTA,ETA};
...
class mesh{
    ...
    public:
        void setParameters(float l,float thao,float kap,float lamb,float v,float psi,float alpha,float delta,float eta){
